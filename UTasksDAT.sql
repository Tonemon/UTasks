...
(5, 'Normal User', 'Deadline passed', '(Voorbeeld) Deze task heeft een datum in het verleden en het systeem telt deze task bij de ''deadlines passed'' kaart.', '2019-11-27 14:25:41', '2019-09-22 09:55:39', 3, 'School (KKC)', 'Ik, Ik en nog eens ik', 0, 0, 2, 'ARCHIVED'),
(6, 'Normal User', 'Archived task', '(Voorbeeld) Deze task is gearchiveerd en hoort onder het kopje ''Archived Tasks'' te komen. Daarnaast staat hij ook bij de archived tasks kaart.', '2019-09-21 09:52:51', '2019-09-22 09:55:39', 3, 'School (KKC)', 'Ik, Ik en nog eens ik', 0, 0, 3, 'ARCHIVED');
