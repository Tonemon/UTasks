...
<html lang="en">
  <head>
	...
	<title>Add/edit/remove users | UTasks Admin Panel </title>
  </head>
  <body id="page-top">
	...
	<?php if ($userdat_acctype == "admin"){ // show this when user is admin ?>
		...
		<!-- Add new users row -->
		  <div class="row">
		    <?php if ($userdat_id == "1"){ echo '<div class="col-xl-4 mb-6">'; // only owner can add accounts manually
		...
		<!-- Approve new users row -->
			<?php if ($userdat_id != "1"){ echo '<div class="col-xl-12 mb-6">'; // makes column bigger if not owner
			  ...
			  <div class="card o-hidden mb-3" id="transfer">
				...
				<div class="card-body">
					...
					<small id="emailHelp" class="form-text">The account requests below are coming from the <a href="http://utasks.me/#register" target="_blank">utasks.me/register</a> page.</small><br>
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
						<?php
							include '_inc/dbconn.php';
							$sql5 = "SELECT * FROM UTasksMAIN.usersnew";
							$result5 = mysql_query($sql5) or die(mysql_error());

							$sql_min5 = "SELECT MIN(id) from UTasksMAIN.users";
			  ...
			  <div class="card o-hidden mb-3" id="transfer">
				...
				<div class="card-body">
					...
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
						<?php
							include '_inc/dbconn.php';
							if ($userdat_id == "1"){ // check if owner (will allow to edit all users)
							...
							$sql_min = "SELECT MIN(id) from UTasksMAIN.users";
				...
				<div class="card-body">
				  <form action="admin-edit" method="POST">
					...
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
						<?php
							include '_inc/dbconn.php';
							$query2 = "SELECT * FROM UTasksMAIN.usersclosed";
							$res2 = mysql_query($query2) or die(mysql_error());
							
							$sql_min = "SELECT MIN(id) from UTasksMAIN.usersclosed";
							$result_min = mysql_query($sql_min);
							$rws2 = mysql_fetch_array($result_min);
						?>
						<thead>
