...
<?php
	...
	if (isset($_REQUEST['q_done'])){ // Marks question as 'done'
	    ...
	    $sql1 = "UPDATE UTasksMAIN.questions SET status='REVIEWED' WHERE id='$qid'";
	    mysql_query($sql1) or die(mysql_error());
		$sql2 = "UPDATE UTasksMAIN.questions SET readby='$reviewer' WHERE id='$qid'";
		...
		$sql1 = "UPDATE UTasksMAIN.questions SET status='DOING' WHERE id='$qid'";
	    mysql_query($sql1) or die(mysql_error());
		$sql2 = "UPDATE UTasksMAIN.questions SET readby='$reviewer' WHERE id='$qid'";
	    mysql_query($sql2) or die(mysql_error());
		...
		$sql = "DELETE FROM UTasksMAIN.questions WHERE id='$qid'";
	    ...
	    $sql = "UPDATE UTasksMAIN.questions SET status='TO REVIEW' WHERE id='$qid'";
	    mysql_query($sql) or die(mysql_error());
		$sql = "UPDATE UTasksMAIN.questions SET readby='' WHERE id='$qid'";
	    mysql_query($sql) or die(mysql_error());
...
<html lang="en">
  <head>
	...
	<title>Support Panel | UTasks Admin Panel</title>
  </head>
  <body id="page-top">
		    ...
		    <div class="col-xl-12 mb-6">
			  <div class="card o-hidden mb-3">
				...
				<div class="card-body">
				  <?php
					include '_inc/dbconn.php';
					$sql1="SELECT * FROM UTasksMAIN.questions WHERE status='TO REVIEW' OR status='DOING'";
		    ...
		    <div class="col-xl-12 mb-6">
			  <div class="card o-hidden mb-3">
				...
				<div class="card-body">
				  <?php
					include '_inc/dbconn.php';
					$sql="SELECT * FROM UTasksMAIN.questions WHERE status='REVIEWED'";
